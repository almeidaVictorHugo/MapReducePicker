...
public class TransactionMediaPesoBrasil {
    ...
    public static void main(String args[]) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        j.setJarByClass(TransactionMediaPesoBrasil.class);
        j.setMapperClass(TransactionMediaPesoBrasil.MapForAverage.class);
        j.setReducerClass(TransactionMediaPesoBrasil.ReduceForAverage.class);
